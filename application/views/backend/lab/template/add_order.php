                            ...
                            <div class="col-md-4 col-sm-12">
                                ...
                                <div class="col-12">
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="labOrderMode" id="homeVisit" value="homeVisit" disabled>
                                        <label class="form-check-label" for="homeVisit">Home Visit</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="labOrderMode" id="labVisit" value="labVisit" checked>
