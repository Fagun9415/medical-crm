...
<head>
    ...
    <title>Quris - Lab Forgot Password</title>
            ...
            <div class="col-md-6 login-wrap-bg">
                ...
                <div class="login-wrapper">
                    <div class="loginbox">
                        ...
                        <input type="hidden" name="loginType" value="lab">
                            ...
                            <div class="dont-have">Remember your password? <a href="<?php echo base_url('lab/Auth/login'); ?>">Login</a>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <script>
      ...
      { 
        ...
        frm.submit(function(e){
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url().'lab/Auth/forgot_password_verify'?>',
                data: formData,
                async: true,
                cache: false,
                contentType: false,
