                    ...
                    <h5 class="mb-1">Payment Details</h5>
                        ...
                        <div class="col-md-6 col-sm-12">
                            <div class="form-group form-check-inline">
                                <p>Amount :  <?php echo $lab->paymentAmount; ?></p>
                                <p>Mode : <?php echo ucwords($lab->paymentMode); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                <?php if ($lab->paymentStatus=="complete") { ?>
            ...
            frm.submit(function(e){
                ...
                $.ajax({
                    ...
                    {   
                        ...
                        if(status == "success")
                        {   
                            location.href = "<?php echo base_url('lab/Order/pending_patient') ?>";   
                        }
