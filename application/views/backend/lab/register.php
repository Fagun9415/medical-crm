...
<head>
    ...
    <title>Curis - Lab Registration</title>
                        ...
                        <form autocomplete="off" enctype='multipart/form-data' id="signupform">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter Lab Name" name="full_name" required>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Lab Registration Number <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" placeholder="Enter Lab Registration Number" name="labRegistrationNo" maxlength="15" required>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Lab Registration Document <span class="text-danger">*</span></label>
                            ...
                            <div class="dont-have">Already have an account? <a href="<?php echo base_url('lab/Auth/login'); ?>">Login</a></div>
                        </form>
                    </div>
                </div>
    ...
    <script>
      ...
      { 
        ...
        frm.submit(function(e){
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url().'lab/Auth/save_user'?>',
                data: formData,
                async: true,
                cache: false,
                contentType: false,
                ...
                {   
                    ...
                    {   $('#alert_message').html('<div class="text-center alert alert-success">'+message+'</div>');
                            location.href = "<?php echo base_url('lab/Auth/login') ?>";   
