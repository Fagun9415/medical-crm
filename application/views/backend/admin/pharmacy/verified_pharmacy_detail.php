                ...
                <div class="row">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <h6><b>Name</b> : <?php echo ucwords($pharmacy->name); ?></h6>    
                                            </div>
                                            <div class="col-md-6">
                                                <h6><b>Phone 1</b> : <?php echo '('.$pharmacy->pharmacyPhoneCode1.')'. $pharmacy->pharmacyPhoneNo1; ?></h6>    
                                            </div>
                                            <?php if ($pharmacy->pharmacyPhoneNo2 != '') { ?>
                                            <div class="col-md-6">
                                                <h6><b>Phone 2</b> : <?php echo '('.$pharmacy->pharmacyPhoneCode2.')'. $pharmacy->pharmacyPhoneNo2; ?></h6>    
                                            </div>
                                            <?php } else {} ?>
                                            <div class="col-md-6">
                                                <h6><b>Email</b> : <?php echo $pharmacy->email; ?></h6>    
                                            </div>
                                            <div class="col-md-6">
                                                <h6><b>Pharmacy Address</b> : <?php echo ucwords($pharmacy->address); ?></h6>    
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <h6><b>License number</b> : <?php echo $pharmacy->pharmacyRegistrationNo; ?></h6>    
                                            </div>
                                            <div class="col-md-6" >
                                                <a href="<?php echo curisurl.$pharmacy->pharmacyRegistrationDocument; ?>" download class="btn btn-success" target="_blank"><i class="fa fa-download"></i></a>            
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-6 col-sm-12">
                        <div style="text-align: right;">
                            ...
                            <input type="checkbox" data-toggle="switchbutton" id="<?php echo my_encrypt($pharmacy->id); ?>" <?php if ($pharmacy->isActive == 1) { echo "checked";} else {} ?> class="status">
                        </div>
                        <div class="row mt-3">
        ...
        Swal.fire({
          title: 'Are you sure?',
              ...
              if (result.value) {
                ...
                $.ajax({
                  url:"<?php echo base_url('admin/Pharmacy/change_status') ?>",
                  method:"POST",
                  data:{id:id},
                  ...
                  { 
                      ...
                      {
                              Swal.fire({
                              title: 'Pharmacy Status Changed successfully!',
                              ...
                              if (result.value) {
                                location.href = "<?php echo base_url('admin/Pharmacy/verified_pharmacy_detail/') ?>"+id;
                              }
