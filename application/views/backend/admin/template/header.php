            ...
            <ul class="nav nav-tabs user-menu">
                ...
                <li class="nav-item dropdown main-drop">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item" href="<?php echo base_url('admin/Auth/edit_profile'); ?>"><i class="feather-edit me-1"></i> Edit Profile</a>
                        <a class="dropdown-item" href="<?php echo base_url('admin/Auth/logout'); ?>"><i class="feather-log-out me-1"></i> Logout</a>
                    </div>
                </li>
                ...
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        <li class="<?php if ($url=='Dashboard' && $url2=='index') { echo 'active'; } ?>">
                            <a href="<?php echo base_url('admin/Dashboard'); ?>"><i class="feather-grid"></i> <span>Dashboard</span></a>
                        </li>
                        <li class="submenu <?php if ($url=='Doctor') { echo 'active'; } ?>">
                            <a href="#"><i class="feather-users"></i><span>Doctors</span> <span
                                    class="menu-arrow"></span></a>
                            <ul>
                                <li class="<?php if ($url=='Doctor' && $url2=='verified_doctor') { echo 'active'; } ?>"><a href="<?php echo base_url('admin/Doctor/verified_doctor'); ?>">Verified Doctors</a></li>
                                <li class="<?php if ($url=='Doctor' && $url2=='unverified_doctor') { echo 'active'; } ?>"><a href="<?php echo base_url('admin/Doctor/unverified_doctor'); ?>">Unverified Doctors</a></li>
                            </ul>
                        </li>
                        <li class="<?php if (($url=='Patient') && ($url2=='patient_list' || $url2=='patient_detail')) { echo "active";} ?>">
                            <a href="<?php echo base_url('admin/Patient/patient_list'); ?>"><i class="feather-users"></i> <span>Patients</span></a>
                        </li>
                        <li class="submenu <?php if ($url=='Pharmacy') { echo 'active'; } ?>">
                            <a href="#"><i class="feather-users"></i><span>Pharmacies</span> <span
                                    class="menu-arrow"></span></a>
                            <ul>
                                <li class="<?php if ($url=='Pharmacy' && $url2=='verified_pharmacy') { echo 'active'; } ?>"><a href="<?php echo base_url('admin/Pharmacy/verified_pharmacy'); ?>">Verified Pharmacies</a></li>
                                <li class="<?php if ($url=='Pharmacy' && $url2=='unverified_pharmacy') { echo 'active'; } ?>"><a href="<?php echo base_url('admin/Pharmacy/unverified_pharmacy'); ?>">Unverified Pharmacies</a></li>
                            </ul>
                        </li>
                        <li class="submenu <?php if ($url=='Lab') { echo 'active'; } ?>">
                            <a href="#"><i class="feather-users"></i><span>Labs</span> <span
                                    class="menu-arrow"></span></a>
                            <ul>
                                <li class="<?php if ($url=='Lab' && $url2=='verified_lab') { echo 'active'; } ?>"><a href="<?php echo base_url('admin/Lab/verified_lab'); ?>">Verified Labs</a></li>
                                <li class="<?php if ($url=='Lab' && $url2=='unverified_lab') { echo 'active'; } ?>"><a href="<?php echo base_url('admin/Lab/unverified_lab'); ?>">Unverified Labs</a></li>
                            </ul>
                        </li>
                        <!-- <li class="<?php if (($url=='Order') && ($url2=='schedule_patient' || $url2=='view_order')) { echo "active";} ?>">
                            <a href="<?php echo base_url('admin/Order/schedule_patient'); ?>"><i class="feather-package"></i> <span>Schedule Patient</span></a>
                        </li> -->
                    </ul>
                </div>
            </div>
