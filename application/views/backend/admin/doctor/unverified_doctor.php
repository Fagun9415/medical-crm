                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        <div class="setting-info profile-info">
                            <h5 class="mb-1 d-flex"><div class="col-6">Unverified Doctors</div></h5>
                            <br>    
                            <hr class="mt-0">
                            <div class="row">
                                <div class="col-12">
    ...
    $(document).ready(function(){
      ...
      function verified_doctor()
      {
        ...
        $('#patient-table').DataTable( {
                "ajax" : {
                    url:"<?php echo base_url('admin/Doctor/fetch_unverified_doctor'); ?>"
      ...
      $(document).on('click', '.status', function()
      {
        ...
        Swal.fire({
          title: 'Are you sure?',
              ...
              confirmButtonText: 'Want to verify this doctor?'
            }).then((result) => {
              if (result.value) {

                $.ajax({
                  url:"<?php echo base_url('admin/Doctor/verify_doctor') ?>",
                  method:"POST",
                  data:{id:id},
                  ...
                  { 
                      ...
                      {
                              Swal.fire({
                              title: 'Doctor Verified successfully!',
