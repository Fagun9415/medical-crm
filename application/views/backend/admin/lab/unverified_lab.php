                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        <div class="setting-info profile-info">
                            <h5 class="mb-1 d-flex"><div class="col-6">Unverified Labs</div></h5>
                            <br>    
                            <hr class="mt-0">
                            <div class="row">
                                <div class="col-12">
    ...
    $(document).ready(function(){
      ...
      function verified_doctor()
      {
        ...
        $('#patient-table').DataTable( {
                "ajax" : {
                    url:"<?php echo base_url('admin/Lab/fetch_unverified_lab'); ?>"
        ...
        Swal.fire({
          title: 'Are you sure?',
              ...
              if (result.value) {
                ...
                $.ajax({
                  url:"<?php echo base_url('admin/Lab/verify_lab') ?>",
                  method:"POST",
                  data:{id:id},
                  ...
                  { 
                      ...
                      {
                              Swal.fire({
                              title: 'Lab Verified successfully!',
