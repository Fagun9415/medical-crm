                            ...
                            <div class="card-body">
                                <form id="signupform" autocomplete="off">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" class="form-control phone-field filterme" id="phoneField1" placeholder="Enter Phone Number 1" name="phoneNo" value="<?php echo $user->pharmacyPhoneNo1; ?>" required maxlength="10">
                                        </div>
                                        <input type="hidden" id="countrycode" name="countrycode" value="<?php echo $user->pharmacyPhoneCode1; ?>">
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-lg-3 col-form-label">Phone Number 2</label>
                                        <div class="col-lg-9">
                                            <input type="text" class="form-control phone-field filterme" id="phoneField2" placeholder="Enter Phone Number 2" name="phoneNo1" value="<?php echo $user->pharmacyPhoneNo2; ?>" <?php if (!empty($user->pharmacyPhoneNo2)) { echo "required"; }  ?> maxlength="10">
                                        </div>
                                        <input type="hidden" id="countrycode1" name="countrycode1" value="<?php echo $user->pharmacyPhoneCode2; ?>">
                                    </div>
                                    <div class="form-group row">
...
{ 
    ...
    frm.submit(function(e){
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url().'pharmacy/Auth/edit_save_profile'?>',
            data: formData,
            async: true,
            cache: false,
            contentType: false,
    ...
    frm.submit(function(e){
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url().'pharmacy/Auth/change_password'?>',
            data: formData,
            async: true,
            cache: false,
            contentType: false,
