    ...
    <div class="main-wrapper">
        ...
        <div class="header">
            ...
            <div class="header-left">
                <a href="<?php echo base_url('pharmacy/Dashboard'); ?>" class="logo">
                    <img src="<?php echo base_url('backend/assets/img/logo.png'); ?>" alt="Logo">
                </a>
                <a href="<?php echo base_url('pharmacy/Dashboard'); ?>" class="logo logo-small">
			...
			<h6>Let Local Live</h6>
                ...
                <li class="nav-item dropdown main-drop">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item" href="<?php echo base_url('pharmacy/Auth/edit_profile'); ?>"><i class="feather-edit me-1"></i> Edit Profile</a>
                        <a class="dropdown-item" href="<?php echo base_url('pharmacy/Auth/logout'); ?>"><i class="feather-log-out me-1"></i> Logout</a>
                    </div>
                </li>
                ...
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <!-- <li class="<?php if (($url=='Order') && ($url2=='new_order' || $url2=='add_order_step_one' || $url2=='add_order_step_two')) { echo "active";} ?>">
                            <a href="<?php echo base_url('pharmacy/Order/new_order'); ?>">
                                <i class="feather-user-plus"></i>
                                <span>New Order</span></a>
                        </li> -->
                        <li class="<?php if (($url=='Order') && ($url2=='schedule_patient' || $url2=='view_order')) { echo "active";} ?>">
                            <a href="<?php echo base_url('pharmacy/Order/schedule_patient'); ?>"><i class="feather-package"></i> <span>Schedule Patient</span></a>
                        </li>
                        <li class="<?php if (($url=='Order') && ($url2=='payment_pending_patient' || $url2=='view_payment_pending_order')) { echo "active";} ?>">
                            <a href="<?php echo base_url('pharmacy/Order/payment_pending_patient'); ?>"><i class="feather-users"></i> <span>Pending Payment Patient</span></a>
                        </li>
                        <li class="<?php if (($url=='Order') && ($url2=='complete_patient' || $url2=='view_complete_order')) { echo "active";} ?>">
                            <a href="<?php echo base_url('pharmacy/Order/complete_patient'); ?>"><i class="feather-users"></i> <span>Complete Patient</span></a>
                        </li>
                    </ul>
                </div>
            </div>
