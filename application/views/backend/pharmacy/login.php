...
<head>
    ...
    <title>Curis - Pharmacy Login</title>
            ...
            <div class="col-md-6 login-wrap-bg">
                ...
                <div class="login-wrapper">
                    <div class="loginbox">
                        ...
                        <form  action="<?php echo base_url('pharmacy/Auth/check_login'); ?>" autocomplete="off" method="post">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-6 text-end">
                                        <a class="forgot-link" href="<?php echo base_url('pharmacy/Auth/forgot_password'); ?>">Forgot Password ?</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="dont-have">Don't have an account? <a href="<?php echo base_url('pharmacy/Auth/register'); ?>">Sign up</a></div>
