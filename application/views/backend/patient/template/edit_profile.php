                            ...
                            <div class="card-body">
                                <form id="signupform" autocomplete="off">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-9">
                                            <input type="text" class="form-control phone-field filterme" id="phoneField1" placeholder="Enter Phone Number" name="phoneNo" value="<?php echo $user->phoneNo; ?>" maxlength="10" required>
                                        </div>
                                        <input type="hidden" id="countrycode" name="countrycode" value="<?php echo $user->phoneCode; ?>">
                                    </div>
      ...
      { 
       ...
       // $("#phoneField1").CcPicker();
        ...
        frm.submit(function(e){
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url().'patient/Auth/edit_save_profile'?>',
                data: formData,
                async: true,
                cache: false,
                contentType: false,
        ...
        frm.submit(function(e){
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url().'patient/Auth/change_password'?>',
                data: formData,
                async: true,
                cache: false,
                contentType: false,
