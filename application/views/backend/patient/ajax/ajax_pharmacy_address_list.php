    ...
    <div class="col-md-3 col-sm-6">
        <div class="card" style="border-color: black;">
            <div class="card-body" role="button">
                <input type="radio" name="pharmacyId" value="<?php echo $value->id; ?>" id="pharmacyId<?php echo $key; ?>" required>
                ...
                <p class="card-text"><?php echo "(".$value->pharmacy_phone_code_1.") ".$value->pharmacy_phone_no_1; ?> <br><?php echo $value->address; ?></p>
            </div>
        </div>
    </div>
