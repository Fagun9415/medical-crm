                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        <div class="setting-info profile-info">
                            <h5 class="mb-1 d-flex"><div class="col-6">Active Doctor Orders of <b><?php echo ucwords($user->name).'('.ucwords($user->role).')'; ?></b></div></h5>
    ...
    $(document).ready(function(){
      ...
      function active_patient_data()
      {
        ...
        $('#patient-table').DataTable( {
                "ajax" : {
                    url:"<?php echo base_url('patient/Order/fetch_active_doctor_order'); ?>"
