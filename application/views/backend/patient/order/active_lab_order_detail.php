<?php
    ...
    if ($order->orderStatus == "prescribe") 
                    {
                        $rstatus = '<button type="button" class="btn btn-primary">Prescribe</button>';
                    }
                    elseif ($order->orderStatus == "pending") 
                    {
                        $rstatus = '<button type="button" class="btn btn-secondary">Pending</button>';
                    }
                    elseif ($order->orderStatus == "processing") 
                    {
                        $rstatus = '<button type="button" class="btn btn-success"><span class="spinner-border spinner-border-sm me-2" role="status"></span>Processing</button>';
                    }
                    else
                    {
                        $rstatus = '';
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        <div class="setting-info profile-info">
                            <h4>Lab Order Alert Detail <?php echo $rstatus; ?></h4>
