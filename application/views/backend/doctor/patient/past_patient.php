                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        <div class="setting-info profile-info">
                            <h5 class="mb-1 d-flex"><div class="col-12">Past Patients</div> </h5>
                            <br>
                            ...
                            <div class="col-md-4">
                                ...
                                <a href="<?php echo base_url('doctor/Patient/past_patient'); ?>" class="btn btn-dark">Reset</a>
                            </div>
                        </form>
                            <br>    
                            <hr class="mt-0">
    ...
    $(document).ready(function(){
      ...
      function past_patient_data()
      {
        ...
        $('#patient-table').DataTable( {
                "ajax" : {
                    url:"<?php echo base_url('doctor/Patient/fetch_past_patient'); ?>",
                    type:"POST",
                    data : {
                        mobileno:mobileno
                    },
