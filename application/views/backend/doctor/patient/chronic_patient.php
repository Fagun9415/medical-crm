                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        <div class="setting-info profile-info">
                            <h5 class="mb-1 d-flex"><div class="col-12">Chronic Patients &nbsp;&nbsp;<a href="<?php echo base_url('doctor/Patient/add_new_patient'); ?>" class="btn btn-primary btn-add"><i class="feather-plus-square me-1"></i> Add New Patient</a></div></h5>
                            <br>
    ...
    $(document).ready(function(){
      ...
      function active_patient_data()
      {
        ...
        $('#patient-table').DataTable( {
                "ajax" : {
                    url:"<?php echo base_url('doctor/Patient/fetch_chronic_patient'); ?>",
                    type:"POST",
                    data : {
                        mobileno:mobileno
                    },
