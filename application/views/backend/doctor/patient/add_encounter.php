 ...
 <script>
     $(document).ready(function() {
         ...
         var availableTags = [
            ...
            $("#chronic-illness").on("change",function(){
                
                if($(this).val().includes("None"))
                {
                    var elements = document.getElementById("chronic-illness").options;
                    for(var i = 1; i < elements.length; i++){
                        elements[i].selected =  false;
                    }
                    $(this).val($("#chronic-illness option:first").val());
                }
                $('#chronic-illness').select2([$(this).val()], null, false);
