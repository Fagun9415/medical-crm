...
<head>
    ...
    <title>Curis - Doctor Forgot Password</title>
                ...
                <div class="login-wrapper">
                    <div class="loginbox">
                        ...
                        <input type="hidden" name="loginType" value="doctor">
                            ...
                            <div class="dont-have">Remember your password? <a href="<?php echo base_url('doctor/Auth/login'); ?>">Login</a>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <script>
      ...
      { 
        ...
        frm.submit(function(e){
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url().'doctor/Auth/forgot_password_verify'?>',
                data: formData,
                async: true,
                cache: false,
                contentType: false,
