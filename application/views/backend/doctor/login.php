...
<head>
    ...
    <title>Curis - Doctor Login</title>
            ...
            <div class="col-md-6 login-wrap-bg">
                ...
                <div class="login-wrapper">
                    <div class="loginbox">
                        ...
                        <form action="<?php echo base_url('doctor/Auth/check_login'); ?>" method="post" autocomplete="off">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-6 text-end">
                                        <a class="forgot-link" href="<?php echo base_url('doctor/Auth/forgot_password'); ?>">Forgot Password ?</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="dont-have">Don't have an account? <a href="<?php echo base_url('doctor/Auth/register'); ?>">Sign up</a></div>
